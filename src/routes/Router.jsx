...
const Router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: () => fetch("https://y-roan-one.vercel.app/FeaturedFoods"),
                errorElement: <Errorpage></Errorpage>
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://y-roan-one.vercel.app/FeaturedFoodss/${params.id}`),
                errorElement: <Errorpage></Errorpage>
            ...
            },
            {
                ...
                loader: () => fetch('https://y-roan-one.vercel.app/requestedFood'),
                errorElement: <Errorpage></Errorpage>
            },
            {
                path: "/EditPage/:id",
